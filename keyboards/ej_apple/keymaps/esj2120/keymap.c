...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = KEYMAP(
		...
		C(KC_F), C(A(KC_DEL)), KC_LGUI, KC_LALT, LOWER, KC_SPC, RAISE, RIGHTWO, KC_LEFT, KC_DNFS, KC_RGHT
		), 
	...
	[_LOWER] = KEYMAP(
		...
		TO(_GAMING), _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_LEFT, KC_DOWN, KC_RIGHT
		),
	...
	[_RAISE] = KEYMAP(
		...
		LSFT(KC_C), _______, _______, _______, _______, _______, _______, _______, KC_WBAK, KC_PGDN, KC_WFWD
		),
	...
	[_RIGHTWO] = KEYMAP(
		...
		_______, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______ , KC_NO, _______, C(KC_LEFT), _______, C(KC_RIGHT)
		),
		
				[_GAMING] = KEYMAP(
					KC_ESC, KC_NO ,KC_1, KC_2, KC_3, KC_4 , KC_5, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
					...
					TO(_QWERTY), KC_J, KC_NO, KC_NO, KC_LALT, KC_SPC, KC_B, KC_C, KC_V, KC_NO, KC_NO 
					),
			
				[_NUMPAD] = KEYMAP(
					KC_ESC, KC_SLCK, KC_UP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PMNS, 
					KC_NLCK, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PPLS, 
					KC_LSFT, KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P1, KC_P2, KC_P3, KC_SFTENT, 
					TO(_QWERTY), KC_NO, KC_NO, KC_NO, KC_BSPC, KC_SPC, KC_NO, KC_P0, KC_PDOT, KC_PDOT, KC_NO 
					),
				...
				_______, _______, _______, _______, _______, _______, _______, _______, RGB_HUI, RGB_SAI, RGB_VAI
			),
